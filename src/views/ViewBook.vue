    ...
    <div class="hero-body">
      <div class="content">
        ...
        <div class="buttons-container">
          <div class="logo">
            <router-link :to="'/'">
              <button class="outline btn-transparent text-light"><BooksIcon /></button>
            </router-link>
          </div>
          <div class="action-items">
            <router-link :to="`/book-edit/${book.slug}`">
              <button class="outline btn-transparent text-success"><AddNoteIcon /></button>
            </router-link>
            <button class="outline btn-transparent text-danger"><TrashIcon /></button>
          </div>
        </div>
      </div>
    </div>
